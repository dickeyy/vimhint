...
#ifndef VIMHINT_SWIFT_H
#define VIMHINT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="vimhint",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7vimhint11AppDelegate")
...
SWIFT_CLASS("_TtC7vimhint13SidebarWindow")
@interface SidebarWindow : NSPanel
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
